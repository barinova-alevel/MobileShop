...
namespace Catalog.Host.Services.Interfaces
{
    ...
    {
        Task<int?> AddAsync(string name, string description, decimal price, string pictureFileName, int laptopBrandId, int screenTypeId, int availableStock, string sku);
